...
const projects = [
  ...
  {
    id: "3tier-app",
    title: "3-Tier Web App on AWS",
    description: "Deployed with CI/CD, Route53, EC2, ALB, RDS, and S3.",
    details:
      "This project is a production-ready 3-tier architecture built with scalability and automation in mind. The app uses Route53 and ALB for routing, EC2 for compute, and RDS for persistent data.",
    github: "https://github.com/yourusername/aws-3tier-app",
    demo: null,
    tech: ["CI/CD", "EC2", "RDS", "S3", "Route53"],
  },
];
